...
<%
	...
	String str;
	String sn = "";
	if ((request.getParameter("tfimgid") == null) || request.getParameter("tfimgid").equals("")){
		out.println("You has not point a SN yet");
%>
		<form action="showitem.jsp" method="post">
			<p><label><input type="text" name="tfimgid"></label><label><input type="submit" name="Submit" value="Submit"></label></p>
		</form>
<%		
		return;
	}else{
	...
	if(thenews == null){
		out.println("Cannot find a record with the appoint sn");
		return;
	}
