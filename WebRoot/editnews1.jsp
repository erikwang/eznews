...
<table width="80%" border="0">
  ...
  <tr>
    ...
    <td height="30"><textarea name="tfmain" cols="95" rows="10"><%=(new NewsText().desortString(str))%></textarea></td>
  </tr>
  <tr>
  ...
  <tr>
    <td height="30">请将下列文本框中代码复制到新闻中的任意位置：</td>
  </tr>
  <tr>
    <td height="30">第二张图片：<input type="file" name="fimga1" />
      <input name="imgdrv2" type="text" id="imgdrv2" value="&lt;img src=servlet/GetAimg1?tfimgid=<%=sn%>&gt;" size="45" /></td>
  </tr>
  <tr>
    <td height="30">第三张图片：<input type="file" name="fimga2" />
      <input name="imgdrv3" type="text" id="imgdrv3" value="&lt;img src=servlet/GetAimg2?tfimgid=<%=sn%>&gt;" size="45" /></td>
  </tr>
  <tr>
    <td height="30">第四张图片：<input type="file" name="fimga3" />
      <input name="imgdrv4" type="text" id="imgdrv4" value="&lt;img src=servlet/GetAimg3?tfimgid=<%=sn%>&gt;" size="45" /></td>
  </tr>
  <tr>
    <td height="30">范围</td>
    <td height="30"><label>
